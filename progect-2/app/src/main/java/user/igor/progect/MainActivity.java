...
// задание полей
    ...
    float apartmentPrice = 35_000; // стоимость квартиры

    float amount = 1_700; // заработная плата в месяц

    float account = 3 * 700; // счёт пользователя
...
// 1) вывод количества месяцев выплаты ипотеки
        ...
        countOut.setText(countMonth(percentBank, amount, percentFree, apartmentPrice, account, monthlyPayments) + " месяцев");
